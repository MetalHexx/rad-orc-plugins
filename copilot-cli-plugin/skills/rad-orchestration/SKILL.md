...
- **`radorch plan explode`** — Pipeline branching and phase expansion subcommand (folded into the radorch CLI; invoked via `node "${COPILOT_CLI_PLUGIN_ROOT}/skills/rad-orchestration/scripts/radorch.mjs" plan explode`)
