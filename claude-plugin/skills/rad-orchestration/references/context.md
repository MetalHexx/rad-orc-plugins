...
>Note:  You should urge a user to go through brainstorming before planning if their idea is still vague.  The brainstorming process is designed to help them clarify their idea and give the rad-orc:planner agent more to work with when it comes time to create formal plans.
