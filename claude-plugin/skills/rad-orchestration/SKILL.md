...
- **`radorch plan explode`** — Pipeline branching and phase expansion subcommand (folded into the radorch CLI; invoked via `node "${CLAUDE_PLUGIN_ROOT}/skills/rad-orchestration/scripts/radorch.mjs" plan explode`)
